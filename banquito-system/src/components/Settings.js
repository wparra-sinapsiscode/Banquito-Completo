...
const Settings = ({ settings, setSettings, loans = [], darkMode, setDarkMode }) => {
  ...
  const saveSettings = async () => {
    try {
      console.log('🔄 Enviando configuraciones al backend:', tempSettings);
      console.log('🔄 Tipo de datos:', typeof tempSettings);
      console.log('🔄 Configuraciones stringificadas:', JSON.stringify(tempSettings, null, 2));
      
      // Guardar en la base de datos
      await systemService.updateSettings(tempSettings);
  ...
  const renderInterestSettings = () => (
    <div className="settings-section">
      ...
      <div className={`setting-group ${darkMode ? 'dark' : ''}`}>
        ...
        <div className="rates-configuration">
          <div className="rate-config-card">
            <h5>🟢 Más de S/ 5,000</h5>
            <div className="rate-config-content">
              ...
              <p className="rate-info">Tasa preferencial para montos altos</p>
              <p className="rate-example">Ejemplo: S/ 7,000 = <strong>S/ {Math.ceil(calculateMonthlyPayment(7000, 12, tempSettings.monthlyInterestRates.high))}</strong>/semana</p>
            </div>
          </div>
          ...
          <div className="rate-config-card">
            ...
            <div className="rate-config-content">
              ...
              <p className="rate-info">Tasa estándar para montos intermedios</p>
              <p className="rate-example">Ejemplo: S/ 3,000 = <strong>S/ {Math.ceil(calculateMonthlyPayment(3000, 12, tempSettings.monthlyInterestRates.medium))}</strong>/semana</p>
            </div>
          </div>
          ...
          <div className="rate-config-card">
            ...
            <div className="rate-config-content">
              ...
              <p className="rate-info">Tasa más alta para montos pequeños</p>
              <p className="rate-example">Ejemplo: S/ 800 = <strong>S/ {Math.ceil(calculateMonthlyPayment(800, 6, tempSettings.monthlyInterestRates.low))}</strong>/semana</p>
            </div>
          </div>
        </div>
      </div>
